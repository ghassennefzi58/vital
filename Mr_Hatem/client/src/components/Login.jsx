...
const Login = ({ setRoleVar, setIDuserVar, setUsernameVar }) => {
  ...
  // Effect hook to check for stored username in localStorage
  useEffect(() => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      ...
      .then((res) => {
        // Set the state variables and store username in localStorage
        ...
        setTimeout(() => {
          setLoading(false);
          // Navigate and show toast notification based on user role
          if (res.data.role === "admin") {
            ...
            navigate("/home");
            toast(`Bienvenue employee : Eya_mmonser`, {
              type: "success",
              position: "bottom-right",
            });
